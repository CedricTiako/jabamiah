...
export const CALENDLY_EMBED_URL = `${CALENDLY_URL}?embed_domain=jabamiah.eu&embed_type=Inline&hide_gdpr_banner=1&background_color=f5f0e6&text_color=2c3a24&primary_color=c4a661`;
