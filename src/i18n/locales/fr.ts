export const fr = {
  translation: {
    ...
    admin: {
      ...
      settingsTitle: "Paramètres cagnotte",
      paypalClientId: "PayPal Client ID",
      paypalClientIdHint: "Sandbox : SB-xxx… / Production : AZxx…",
      donationAmounts: "Montants suggérés",
      donationAmountsHint: "Montants en euros, séparés par des virgules (ex : 5,10,20,50)",
    ...
    testimonialsPage: {
      ...
      formBody: "Votre témoignage",
      formSubmit: "Envoyer mon témoignage",
      formSending: "Envoi…",
      formSuccess: "Merci pour votre témoignage ! Il sera publié après validation.",
      formError: "Une erreur est survenue. Merci de réessayer.",
      formNameMin: "Le nom doit contenir au moins 2 caractères.",
      formBodyMin: "Votre témoignage doit contenir au moins 10 caractères.",
    },
  },
};
