  ...
  return (
    ...
    >
      ...
      <p>
        ...
        l'utilisation du site <strong>{SITE_URL.replace(/^https?:\/\//, "")}</strong>{" "}
      ...
      <p>
        ...
        Internet. Les frais de connexion sont à la charge exclusive de l'utilisateur.
        L'éditeur se réserve le droit de suspendre l'accès pour des raisons de maintenance
        ou de mise à jour, sans que cela ouvre droit à indemnisation.
      </p>

      <h2>3. Services proposés</h2>
      <p>
        Le Site présente les activités de bien-être et d'accompagnement énergétique de
        Jabamiah. Les consultations sont proposées à titre gratuit sur rendez-vous et
        constituent un accompagnement de <strong>confort et de bien-être</strong>. Elles ne
        constituent pas un acte médical, ne posent aucun diagnostic et ne se substituent pas
        à une consultation ou à un traitement médical. En cas de doute sur votre santé,
      ...
      <p>
        L'ensemble des éléments du Site (textes, images, logos, marques, code source, mise
        en page) est protégé par le droit d'auteur et le droit des marques. Toute
      ...
      <p>
        ...
        sans toutefois pouvoir en garantir l'exhaustivité ou l'absence d'erreur. L'éditeur
      ...
      <p>
        ...
        <a href="/politique-de-confidentialite">Politique de confidentialité</a>. La gestion
        des cookies est détaillée dans notre <a href="/cookies">Politique cookies</a>.
      </p>

      <h2>8. Modification des CGU</h2>
      <p>
        Les présentes CGU peuvent être modifiées à tout moment. La version en vigueur est
        celle publiée sur le Site à la date de consultation.
      </p>

      <h2>9. Droit applicable et juridiction</h2>
      <p>
        Les présentes CGU sont soumises au <strong>droit français</strong>. À défaut de
        résolution amiable, tout litige sera soumis aux tribunaux français compétents.
      </p>
