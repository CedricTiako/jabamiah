...
function DonatePage() {
  ...
  const isPaymentActive = Boolean(settings.paypal_client_id);
  const amounts = settings.donation_amounts.length > 0 ? settings.donation_amounts : [5, 10, 20, 50];
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-forest text-cream">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-24 text-center">
          ...
          <h1 className="mt-4 font-serif text-5xl leading-[1.05] md:text-6xl">{t("donate.title")}</h1>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-cream/85">{t("donate.subtitle")}</p>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8 space-y-5">
              <div className="rounded-xl bg-cream-warm p-6 ring-1 ring-gold/20">
                ...
                <p className="mt-3 text-sm leading-relaxed text-earth/80">{t("donate.cause1Text")}</p>
              </div>
              ...
              <div className="rounded-xl bg-cream-warm p-6 ring-1 ring-gold/20">
                ...
                <p className="mt-3 text-sm leading-relaxed text-earth/80">{t("donate.cause2Text")}</p>
              </div>
            </div>
            ...
            <div className="mt-6 rounded-xl border border-gold/30 bg-cream p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-serif text-lg text-forest">{t("donate.transparencyTitle")}</h3>
                  <p className="mt-2 text-sm leading-relaxed text-earth/80">{t("donate.transparencyText")}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-8 rounded-2xl bg-card p-8 ring-1 ring-gold/20">
              ...
              <div className="mt-6">
                {isPaymentActive ? (
                  <div id="paypal-button-container" className="min-h-[50px]" data-amount={effectiveAmount} />
                ) : (
                  <div className="rounded-xl border-2 border-dashed border-gold/40 bg-cream-warm/60 px-6 py-8 text-center">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-earth/70">{t("donate.pendingSub")}</p>
